...
MysticalElf = NormalMonsterCardModel("Mystical Elf", medesc, 'kero_chill.png', "Light", "Spellcaster", 4, 800, 2000)
AlexandriteDragon = NormalMonsterCardModel("Alexandrite Dragon", addesc, 'alexandrite_dragon.jpg',"Light", "Dragon", 4, 2000, 100)
SummonedSkull = NormalMonsterCardModel("Summoned Skull", ssdesc, 'barrel_dragon.png', "Dark", "Fiend", 6, 2500, 1200)
